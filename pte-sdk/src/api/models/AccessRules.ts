...
export function AccessRulesFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccessRules {
    ...
    return {
        ...
        'defaultRule': !exists(json, 'default_rule') ? undefined : json['default_rule'],
        'methodRules': !exists(json, 'method_rules') ? undefined : ((json['method_rules'] as Array<any>).map(MethodRuleFromJSON)),
    };
}
...
export function AccessRulesToJSON(value?: AccessRules | null): any {
    ...
    return {
        ...
        'method_rules': value.methodRules === undefined ? undefined : ((value.methodRules as Array<any>).map(MethodRuleToJSON)),
    };
}
