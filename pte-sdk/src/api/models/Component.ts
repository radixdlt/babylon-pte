...
export function ComponentFromJSONTyped(json: any, ignoreDiscriminator: boolean): Component {
    ...
    return {
        ...
        'accessChecks': !exists(json, 'access_checks') ? undefined : ((json['access_checks'] as Array<any>).map(AccessRulesFromJSON)),
        'state': json['state'],
...
export function ComponentToJSON(value?: Component | null): any {
    ...
    return {
        ...
        'access_checks': value.accessChecks === undefined ? undefined : ((value.accessChecks as Array<any>).map(AccessRulesToJSON)),
        'state': value.state,
